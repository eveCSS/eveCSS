...
public abstract class AbstractDevice {
	...
	public String getFullIdentifyer() {
		String fullIdentifyer = null;
		
		if (this.parent!=null) {
			if (this.parent.parent!=null) {
				if (!this.parent.parent.getName().equals(""))
					fullIdentifyer = this.parent.parent.getName();
			}
			if (!this.parent.getName().equals("")){
				if (fullIdentifyer!=null) {
					fullIdentifyer += " ";
					fullIdentifyer += this.parent.getName();
				}
				else
					fullIdentifyer = this.parent.getName();
			}
		...
		fullIdentifyer += this.getID() + " )";
		
		return fullIdentifyer;
	}
