 ...
 * 
 */
public class PvTextComposite_dal extends Composite implements IProcessVariableValueListener, SelectionListener {
	 ...
	 */
	public PvTextComposite_dal(Composite parent, int style, String pvname) {
		super(parent, style);
		this.pvname = pvname;
