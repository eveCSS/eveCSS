...
/**
 * ScanModuleViewComposite contains mechanisms common to all composites in the 
 * ScanModuleView.
 * 
 * <ul>
 ...
 * @since 1.31
 */
public abstract class ScanModuleViewComposite extends Composite implements 
		ISelectionListener {
	private ScanModuleView parentView;
	
	public ScanModuleViewComposite(final ScanModuleView parentView, 
	 ...
	 */
	protected ScanModuleView getParentView() {
