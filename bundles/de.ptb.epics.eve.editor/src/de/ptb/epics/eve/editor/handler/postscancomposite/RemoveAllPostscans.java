...
/**
 * Default handler of the remove all postscans command.
 * 
 * @author Marcus Michalsky
 * @since 1.2
 */
public class RemoveAllPostscans implements IHandler {

	private static Logger logger = 
			Logger.getLogger(RemoveAllPostscans.class.getName());
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (activePart.getSite().getId().equals(
			...
			sm.removeAllPostscans();
		} else {
			logger.warn("Postscans could not be removed!");
