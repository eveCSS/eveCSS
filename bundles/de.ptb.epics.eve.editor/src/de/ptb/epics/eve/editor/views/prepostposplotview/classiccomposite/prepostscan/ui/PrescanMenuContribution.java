 ...
 * @since 1.35
 */
public class PrescanMenuContribution extends CompoundContributionItem {
	private static final String OPTION_NAME_STATUS = "Status";
	private static final String OPTION_NAME_SEVERITY = "Severity";
	private static final String COMMAND_ADDPRESCAN_COMMAND_ID = 
			"de.ptb.epics.eve.editor.command.scanmodule.addprescan";
	private static final String COMMAND_ADDPRESCAN_PARAM_PRESCANID = 
			"de.ptb.epics.eve.editor.command.scanmodule.addprescan.prescanid";

	private static final Logger LOGGER = Logger.getLogger(
			PrescanMenuContribution.class.getName());
					...
					for(final MotorAxis motorAxis : motor.getAxes()) {
						...
						if (motorAxis.getClassName().isEmpty()) {
							...
							for(final Option option : motorAxis.
								...
								params.put(COMMAND_ADDPRESCAN_PARAM_PRESCANID, 
										option.getID());
								CommandContributionItemParameter p = 
									new CommandContributionItemParameter(
										PlatformUI.getWorkbench().getActiveWorkbenchWindow(), 
										"", 
										COMMAND_ADDPRESCAN_COMMAND_ID, 
										SWT.PUSH);
