 ...
 * @since 1.35
 */
public class AddPlotWindowDefaultHandler extends AbstractHandler {
	private static final Logger LOGGER = Logger.getLogger(
			AddPlotWindowDefaultHandler.class.getName());
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (activePart instanceof AbstractScanModuleView) {
			ScanModule scanModule = ((AbstractScanModuleView)activePart).
					getScanModule();
			scanModule.add(new PlotWindow(scanModule, true));
		} else {
