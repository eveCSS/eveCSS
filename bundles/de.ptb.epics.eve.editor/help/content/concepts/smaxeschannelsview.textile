...
p. Allows adding/removing of and displays current motor axes. Properties of selected axes can be modified either "directly in the table":../tasks/editaxisproperties.html or in the "Motor Axis View":motoraxisview.html.

h3(eveTopic). Detector Channels

p. Allows adding/removing of and displays current detector channels. Properties of selected channels can be modified either "directly in the table":../tasks/editchannelproperties.html or in the "Detector Channel View":detectorchannelview.html.
