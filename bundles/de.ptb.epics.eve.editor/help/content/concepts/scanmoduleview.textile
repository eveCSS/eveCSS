...
p. For a common scan module the Scan Module View looks as follows:
...
* __Motor Axes__: Allows adding/removing of and displays current motor axes. Properties of selected axes can be viewed or modified in the "Motor Axis View":motoraxisview.html.
* __Detector Channels__: Allows adding/removing of and displays current detector channels. Properties of selected channels can be viewed or modified in the "Detector Channel View":detectorchannelview.html.
