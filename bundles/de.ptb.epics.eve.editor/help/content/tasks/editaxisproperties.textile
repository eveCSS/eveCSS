...
p. Several properties of an axis added to a scan module can be modified within the motor axes table of the SM Axes / Channels View. They are explained in detail below.
...
p=. !(eveImage)../../img/tasks/editaxisproperties/editaxisproperties-.png()!