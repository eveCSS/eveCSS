...
h2(eveTopic). Version 1.30.7 (2019-??-??)

* new template files @leicaAT40x@ and @leicaAT40xChannel@ for the laser tracker AT403 and new template @basicDeferredDetector@ to read a PV as deferred
