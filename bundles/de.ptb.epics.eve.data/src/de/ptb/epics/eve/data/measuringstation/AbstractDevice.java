...
/**
 * <code>AbstractDevice</code> is the base of all devices in the data model. It
 * describes the measuring station (e.g. motors, detectors).
 * 
...
public abstract class AbstractDevice implements Comparable<AbstractDevice> {
	 ...
	 * @param options
	 *            a <code>List</code> of <code>Option</code>s of the device (use
	 *            'null' for no options)
	 * @param parent
	 *            the parent of the device
	 * @throws IllegalArgumentException
	 *             if name or id is <code>null</code>
	 * @throws IllegalArgumentException
	 *             if parent has an illegal type
	 */
	...
	/**
	 * Returns the full identifier of a device as follows: Every device is
	 * addressable by it's full identifier consisting of its own name, and the
	 * name of its parent device. If the device has no name, the id is used to
	 ...
	 * ... detector channel will be: Detector-Name Channel-Name (Channel-Id). <br>
	 * ... option of a motor will be: Motor-Name Option-Name (Option-Id). <br>
	 * ... option of a motor axis will be: Motor-Name Axis-Name Option-Name
	 * (Option-Id).<br>
	 * ... option of an detector will be: Detector-Name Option-Name (Option-Id). <br>
	 ...
	 * 
	 * @param id
	 *            A <code>String</code>, that contains the id of the device.
	 * @throws IllegalArgumentException
	 ...
	 * 
	 * @param option
	 *            The Option that should be added.
	 * @return <code>true</code> if the <code>Option</code> was added,
	 *         <code>false</code> otherwise
	 * @throws IllegalArgumentException
	 *             if the argument is <code>null</code>
	 * @throws IllegalArgumentException
	 *             if option not possible for device
	 */
	 ...
	 * 
	 * @param option
	 *            The <code>Option</code> that should be removed.
	 ...
	 * 
	 * @param name
	 *            A <code>String</code> that contains the name of the device
	 * @throws IllegalArgumentException
	 *             if the argument is <code>null</code>
	 */
	...
	/**
	 * Sets the parent of this device. Override this method to control which
	 * types are allowed. After checking call the method of the super class.
	 * 
	 * @param parent
	 ...
	 * 
	 * @param obj
	 *            the <code>Object</code> that should be checked
	 * @return <code>true</code> if objects are equal, <code>false</code>
	 *         otherwise
	 */
	@Override
