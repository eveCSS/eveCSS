...
public class StatusTableSelectionListener extends SelectionAdapter implements 
	...
	public void widgetSelected(SelectionEvent e) {
		...
		if (aktSM > 0) {
			...
			if (displayChain.getScanDescription().isSaveScanDescription()) {
			...
			if (displayChain.getScanDescription().isConfirmSave()) {
			...
			if (displayChain.getScanDescription().isAutoNumber()) {
			...
			commentText.setText(displayChain.getScanDescription().getComment());
			gridData = new GridData();
			gridData.horizontalAlignment = GridData.FILL;
