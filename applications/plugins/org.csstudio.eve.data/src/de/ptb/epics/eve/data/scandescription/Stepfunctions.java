...
public enum Stepfunctions {
	...
	/**
	 * This step function adds a value to the current position until the end value has been reached.
	 */
	ADD,
	
	/**
	 * This step function multiplies the current position with a given value until the end position has been reached..
	 */
	MULTIPLY,
	...
	/**
	 * This step function indicates that the axis is controlled by a list of values.
	 */
	POSITIONLIST;
	 ...
	 * 
	 *  The strings are the values of the enum, beginning with upper case and continues with lower case letters.
	 * 
	 * @param stepfunction The string of the step function. Must not be null!
	 * @return The corresponding enum value. The value ADD is returned it the string is unknown.
	 */
	 ...
	 * 
	 * @param stepenum The value of the step function enum.
	 * @return The string.
	 */
