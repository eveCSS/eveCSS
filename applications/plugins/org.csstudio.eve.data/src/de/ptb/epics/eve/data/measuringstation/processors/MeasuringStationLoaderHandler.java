			...
			for (Option o : det.getOptions()) {
				if (o.getValue().getAccess().getMonitor()) {
					this.measuringStation.add(new Event(
							o.getValue().getAccess(), 
							o.getValue().getValue(), 
							det.getName() + " " + (char)187 + " " + o.getName(), 
							o.getID()));
				}
			}
		}
