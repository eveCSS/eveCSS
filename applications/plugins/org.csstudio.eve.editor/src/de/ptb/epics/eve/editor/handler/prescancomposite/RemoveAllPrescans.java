...
/**
 * Default handler of the remove all prescans command.
 * 
 * @author Marcus Michalsky
 * @since 1.2
 */
public class RemoveAllPrescans implements IHandler {

	private static Logger logger = 
			Logger.getLogger(RemoveAllPrescans.class.getName());
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (activePart.getSite().getId().equals(
			...
			sm.removeAllPrescans();
		} else {
			logger.warn("Prescans could not be removed!");
