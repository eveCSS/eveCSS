...
/**
 * <code>AddPlotWindow</code>.
 * 
 * @author Marcus Michalsky
 * @since 1.1
 */
public class AddPlotWindow implements IHandler {

	private static Logger logger = 
			Logger.getLogger(AddPlotWindow.class.getName());
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (activePart.getSite().getId().equals(
			"de.ptb.epics.eve.editor.views.ScanModulView")) {
				...
				sm.add(new PlotWindow(sm, true));
				logger.debug("Plot Window added.");
		} else {
			logger.error("Plot Window could not be added.");
		}
		return null;
	}
