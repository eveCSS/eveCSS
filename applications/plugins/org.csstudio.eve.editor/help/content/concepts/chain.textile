...
p. If __Add Autoincrementing Number to Filename__ is true, a five digit number is appendet to the filename. Starting at __x + 1__ where __x__ is the lagest number found with the same filename frefix.
...
p. In the __Events__ Tab you choose which Events you need in the chain. The description of events an which event types are available in the chain view you found "here":events.html
