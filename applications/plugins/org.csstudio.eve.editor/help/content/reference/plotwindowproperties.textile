...
| __normalize with__| if a normalize channel has been set for the selected detector you can choose whether the normalized value should be plotted| boolean| ==&#8212;==|
...
p. *Note:* __Detector Channel, normalize with, Color, Linestyle, Markstyle__ and __Scaletype__ appear twice (once for each y axis).
