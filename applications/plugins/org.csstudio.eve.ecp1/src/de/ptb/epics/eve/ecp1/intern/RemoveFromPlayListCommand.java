...
public class RemoveFromPlayListCommand implements IECP1Command {
	...
	public RemoveFromPlayListCommand( final byte[] byteArray ) throws IOException, AbstractRestoreECP1CommandException {
		if( byteArray == null ) {
		...
		if( commandTypeID != RemoveFromPlayListCommand.COMMAND_TYPE_ID ) {
			throw new WrongTypeIdException( byteArray, commandTypeID, RemoveFromPlayListCommand.COMMAND_TYPE_ID );
		}
