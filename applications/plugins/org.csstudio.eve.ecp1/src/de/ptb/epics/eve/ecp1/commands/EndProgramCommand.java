...
public class EndProgramCommand implements IECP1Command {

	public static final char COMMAND_TYPE_ID = 0x0006;
	
	public EndProgramCommand() {
		
	}
	
	public EndProgramCommand( final byte[] byteArray ) throws IOException, AbstractRestoreECP1CommandException {
		if( byteArray == null ) {
		...
		if( commandTypeID != EndProgramCommand.COMMAND_TYPE_ID ) {
			throw new WrongTypeIdException( byteArray, commandTypeID, EndProgramCommand.COMMAND_TYPE_ID );
		}
