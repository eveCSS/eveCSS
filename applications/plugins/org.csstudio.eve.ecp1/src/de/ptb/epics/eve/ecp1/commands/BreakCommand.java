...
public class BreakCommand implements IECP1Command {


	public static final char COMMAND_TYPE_ID = 0x0003;
	
	public BreakCommand() {
		
	}
	
	public BreakCommand( final byte[] byteArray ) throws IOException, AbstractRestoreECP1CommandException {
		if( byteArray == null ) {
		...
		if( commandTypeID != BreakCommand.COMMAND_TYPE_ID ) {
			throw new WrongTypeIdException( byteArray, commandTypeID, BreakCommand.COMMAND_TYPE_ID );
		}
	...
	public byte[] getByteArray() throws IOException {
		...
		dataOutputStream.writeChar( BreakCommand.COMMAND_TYPE_ID );
