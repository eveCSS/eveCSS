...
public class HaltCommand implements IECP1Command {

	public static final char COMMAND_TYPE_ID = 0x0002;
	
	public HaltCommand() {
		
	}
	
	public HaltCommand( final byte[] byteArray ) throws IOException, AbstractRestoreECP1CommandException {
		if( byteArray == null ) {
		...
		if( commandTypeID != HaltCommand.COMMAND_TYPE_ID ) {
			throw new WrongTypeIdException( byteArray, commandTypeID, HaltCommand.COMMAND_TYPE_ID );
		}
	...
	public byte[] getByteArray() throws IOException {
		...
		dataOutputStream.writeChar( HaltCommand.COMMAND_TYPE_ID );
