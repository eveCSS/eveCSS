...
public class AutoPlayCommand implements IECP1Command {
	...
	public AutoPlayCommand( final byte[] byteArray ) throws IOException, AbstractRestoreECP1CommandException {
		if( byteArray == null ) {
		...
		if( commandTypeID != AutoPlayCommand.COMMAND_TYPE_ID ) {
			throw new WrongTypeIdException( byteArray, commandTypeID, AutoPlayCommand.COMMAND_TYPE_ID );
		}
