...
public class StartCommand implements IECP1Command {

	public static final char COMMAND_TYPE_ID = 0x0001;
	
	public StartCommand() {
		
	}
	
	public StartCommand( final byte[] byteArray ) throws IOException, AbstractRestoreECP1CommandException {
		if( byteArray == null ) {
		...
		if( commandTypeID != StartCommand.COMMAND_TYPE_ID ) {
			throw new WrongTypeIdException( byteArray, commandTypeID, StartCommand.COMMAND_TYPE_ID );
		}
	...
	public byte[] getByteArray() throws IOException {
		...
		dataOutputStream.writeChar( StartCommand.COMMAND_TYPE_ID );
