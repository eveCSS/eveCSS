...
public class StopCommand implements IECP1Command {

	public static final char COMMAND_TYPE_ID = 0x0004;
	
	public StopCommand() {
		
	}
	
	public StopCommand( final byte[] byteArray ) throws IOException, AbstractRestoreECP1CommandException {
		if( byteArray == null ) {
		...
		if( commandTypeID != StopCommand.COMMAND_TYPE_ID ) {
			throw new WrongTypeIdException( byteArray, commandTypeID, StopCommand.COMMAND_TYPE_ID );
		}
	...
	public byte[] getByteArray() throws IOException {
		...
		dataOutputStream.writeChar( StopCommand.COMMAND_TYPE_ID );
