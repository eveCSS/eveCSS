...
public class ErrorCommand implements IECP1Command {
	...
	public ErrorCommand(final int generalTimeStamp, final int nanoseconds,
			final ErrorSeverity errorSeverity,
			final ErrorFacility errorFacility, final ErrorType errorType,
			final String text) {
	...
	public ErrorCommand(final byte[] byteArray) throws IOException,
		...
		this.errorSeverity = ErrorSeverity.byteToErrorSeverity(dataInputStream
				.readByte());
		this.errorFacility = ErrorFacility.byteToErrorFacility(dataInputStream
				.readByte());
	...
	public byte[] getByteArray() throws IOException {
		...
		dataOutputStream.writeByte(ErrorSeverity
				.errorSeverityToByte(this.errorSeverity));
		dataOutputStream.writeByte(ErrorFacility
				.errorFacilityToByte(this.errorFacility));
