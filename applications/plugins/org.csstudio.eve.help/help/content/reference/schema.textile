  ...
  <element name ="scml">
    <complexType>
      <sequence>
        ...
        <element name="measuringstation" type="string" minOccurs="0"></element>
        <element name="repeatcount" type="tns:repeatcount" default="0"></element>
        <element name="chain" type="tns:chain" maxOccurs="unbounded" minOccurs="0"></element>
...
\n
  <complexType name="pauseevent">
    <sequence>
      ...
      <element name="continue_if_false" type="boolean" minOccurs="0"></element>
    </sequence>
...
\n
  <complexType name="scanmodule">
    <sequence>
      ...
      <element name="parent" type="nonNegativeInteger"></element>
      ...
      <element name="triggerconfirm" type="boolean" minOccurs="0"></element>
      <element name="saveaxispositions" type="tns:saveAxisPositions" minOccurs="0"></element>
...
\n
  <complexType name="axis">
    <sequence>
      ...
      <element name="setmode" type="tns:access" minOccurs="0"></element>
...
\n
  <complexType name="smaxis">
    <sequence>
      <element name="axisid" type="string"></element>
...
\n
  <complexType name="smchannel">
    <sequence>
      ...
      <element name="confirmtrigger" type="boolean" minOccurs="0"></element>
...
\n
 <complexType name="positioning">
    <sequence>
      <element name="axis_id" type="string"></element>
      <element name="channel_id" type="string"></element>
      <element name="normalize_id" type="string" minOccurs="0"></element>   
      <element name="plugin" type="tns:controller"></element>
    </sequence>
  </complexType>
\n
