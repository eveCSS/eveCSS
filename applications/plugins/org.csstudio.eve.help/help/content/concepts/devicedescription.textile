...
p. A device description (file) is a collection of devices defined in XML. It is a list of motors and axes, detectors and channels, devices, options, plug ins and events. A device description file is required in order to run the EVE application.
