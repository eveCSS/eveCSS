...
| __Add Autoincrementing Number to Filename__ | if __true__ a four digit number is appended to the file name (starting at __x + 1__ where __x__ is the largest number found with the same filename prefix) | {true, false}|
