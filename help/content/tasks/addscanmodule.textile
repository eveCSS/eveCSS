...
There are two kinds of scan modules you cann add: 1) an appended scan module, 2) a nested scan module. Starting with an "empty scan description":createscandescription.html follow these steps:
==<br/>==
